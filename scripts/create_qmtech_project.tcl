...
puts $fp "# Channel A data \[11:0\] — JP2 pins 3-25 (odd, left column)"
puts $fp "set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[0\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[1\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN U20 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[2\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN W20 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[3\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN P19 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[4\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[5\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[6\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[7\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[8\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[9\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[10\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} \[get_ports {adc_a_data\[11\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} \[get_ports adc_a_otr\]"
puts $fp ""
puts $fp "# Channel B data \[11:0\] — JP2 pins 4-26 (even, right column)"
puts $fp "set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[0\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN R19 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[1\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN T20 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[2\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[3\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN Y20 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[4\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[5\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[6\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[7\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[8\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[9\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[10\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} \[get_ports {adc_b_data\[11\]}\]"
puts $fp "set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} \[get_ports adc_b_otr\]"
puts $fp ""
puts $fp "# ADC clock output"
puts $fp "set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} \[get_ports adc_clk\]"
puts $fp ""
puts $fp "# ── EDM I/O on JP5 (BANK35) ──────────────────────────────"
puts $fp "set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} \[get_ports pulse_out\]"
puts $fp "set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} \[get_ports hv_enable\]"
puts $fp "set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33 PULLUP true} \[get_ports hv_enable\]"
puts $fp "set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} \[get_ports lamp_green\]"
puts $fp "set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} \[get_ports lamp_orange\]"
puts $fp "set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} \[get_ports lamp_red\]"
puts $fp ""
puts $fp "# AXI-Stream tready tie-off"
puts $fp "set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} \[get_ports m_axis_tready_port\]"
puts $fp "set_property PULLDOWN true \[get_ports m_axis_tready_port\]"
close $fp
